        ...
        <view class="modal-content">
          ...
          <view class="detail-section">
            ...
            <view class="detail-item">
              ...
              <text class="detail-value">{{ selectedRule.created_by_name || '未知' }}</text>
            </view>
          </view>
...
import { getCommunityRules, enableCommunityRule, disableCommunityRule, deleteCommunityRule } from '@/api/community-checkin'
...
const totalRules = computed(() => {
  return groupedRules.value.disabled.length + 
