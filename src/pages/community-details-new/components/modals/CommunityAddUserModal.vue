        ...
        <template v-if="isAnkaFamily">
          <form class="create-user-form" @submit.prevent="handleCreateUser">
            ...
            <view class="form-field">
              ...
              />
              <text v-if="formErrors.phone" class="error-text">{{ formErrors.phone }}</text>
            </view>
        ...
        <template v-else>
          <view class="search-section">
            <view class="search-input-wrapper">
              ...
              />
              <button v-if="searchQuery" class="clear-button" @click="clearSearch" :disabled="searching">
              ...
              >
                <view class="user-info">
                  ...
                  <view class="user-details">
                    ...
                    <text class="user-phone">{{ formatPhoneNumber(user.phoneNumber) }}</text>
                  </view>
                </view>
                <button
                  class="add-button"
                ...
                >
                  <text v-if="addingUser === user.userId" class="button-text">添加中...</text>
